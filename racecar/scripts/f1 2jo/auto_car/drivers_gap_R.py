...
class reactive_follow_gap:
    ...
    def gap_R(self, data):
        ...
        lidar = list(data.ranges)
        NUM_RANGES = len(lidar)
        NUM_PER_QUADRANT = NUM_RANGES // 4
        
        min_idx = np.argmin(lidar[NUM_PER_QUADRANT:-NUM_PER_QUADRANT]) + NUM_PER_QUADRANT
